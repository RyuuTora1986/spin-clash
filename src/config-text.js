(function(){
  ...
  const textEn = {
    ...
    routeFromLabel:'FROM',
    homeRoute:'HOME',
    continuePath:'CHAMPIONSHIP PATH',
    enterBattle:'CHAMPIONSHIP PATH',
    ...
    topUnlockShopCost:'Tap the showcase card to buy for {cost} {currency}',
    ...
    homeTopLockedHintShop:'Tap this showcase card to buy when you have enough SCRAP.',
    ...
    titleBuildVersion:'Version 1.2.7',
    titleCopyright:'© 2026 HAKUROKUDO K.K. / Lumos',
    ...
    arenaOptions:['Azure Ring Court','Scarlet Heart Verge','Shard Hex Array','Tempest Maw Depth','Thornbloom Snare','Prism Arcade','Heart Entry Bowl','Hex Entry Bowl','Redline Training Ring'],
    fightButton:'START MATCH',
    challengeButton:'CHAMPIONSHIP PATH',
    ...
    resultGuidanceChallengeContinue:'Continue this run now if you want another shot at the same node. If not, tune your loadout before the next attempt.',
    resultGuidanceChallengeRetry:'This run ends here. Go back, tune the loadout, and attack the same node again with a cleaner opener.',
    resultGuidanceChallengeAdvance:'The next node is ready. Take the payout, then push the road while your current momentum is still clear.',
    resultGuidanceRoadClear:'Road clear secured. Collect the payout first, then decide whether to replay for cleaner clears and extra scrap.',
    resultGuidanceQuickWin:'You won the duel. Take the payout, then queue another short match or rotate your setup while the matchup is fresh.',
    resultGuidanceQuickLoss:'You still keep the payout. Decide whether to tune the setup first or jump back into another short duel immediately.',
    ...
    workshopNext:'NEXT',
    workshopImpactLabel:'NEXT DUEL IMPACT',
    workshopCostReady:'Spend now and keep {remaining} {currency} in reserve.',
    workshopCostShort:'Need {shortfall} more {currency} before this upgrade is affordable.',
    workshopCostMaxed:'This line is capped. Shift scrap into another track.',
    ...
    challengeRewardKicker:'CLEAR REWARD',
    ...
    challengeGoalAdvance:'Clear this node to claim the payout and unlock the next duel.',
    challengeGoalRetry:'This node is the current gate. Tune the opener, then come back for a cleaner clear.',
  ...
  const textZh = {
    ...
    topUnlockShopCost:'点击当前展示卡，花费 {cost} {currency} 购买',
    ...
    homeTopLockedHintShop:'点击当前陀螺展示卡；SCRAP 足够时即可购买。',
    ...
    arenaOptions:['苍轮斗庭','绯心曲域','断棱角阵','岚涡深渊','棘华幽阱','八镜回廊','心域引导场','六角引导场','红线引导场'],
    fightButton:'开始对战',
    challengeButton:'冠军之路',
    roundNext:'下一回合即将开始',
    replay:'再来一局',
    nextNode:'下一节点',
    retryNode:'重试节点',
    ...
    workshopCurrent:'当前',
    workshopNext:'下一级',
    workshopImpactLabel:'下一局影响',
    workshopCostReady:'现在就能买，买完后还剩 {remaining} {currency}。',
    workshopCostShort:'还差 {shortfall} {currency}，这项升级才够买。',
    workshopCostMaxed:'这条研究已经拉满，可以把 SCRAP 投到别的方向。',
    ...
    challengeGoalAdvance:'拿下这一战就能领到结算，并继续推进到下一节点。',
    challengeGoalRetry:'当前节点就是门槛。先把开局和碰撞节奏调顺，再回来拿下它。',
  ...
  const textJa = {
    ...
    routeFromLabel:'遷移元',
    homeRoute:'ホーム',
    continuePath:'チャンピオンロード',
    enterBattle:'チャンピオンロード',
    loadoutTitle:'トップを選択',
    ...
    topUnlockShopCost:'展示カードを押して {cost} {currency} で購入',
    ...
    homeTopLockedHintShop:'この展示カードを押すと、SCRAP が足りるときに購入できる。',
    ...
    arenaOptions:['蒼輪闘庭','緋心曲域','断稜角陣','嵐渦深淵','棘華幽阱','八鏡回廊','ハート導入ボウル','ヘックス導入ボウル','レッドライン導入リング'],
    fightButton:'対戦開始',
    challengeButton:'チャンピオンロード',
    ...
    resultGuidanceChallengeContinue:'このノードにすぐ再挑戦したいなら、まず続行を使う。急がないなら、先にロードアウトを整える方が安定する。',
    resultGuidanceChallengeRetry:'今回はここまで。ロードアウトを整え直し、もっときれいな初動で同じノードに戻るのがよい。',
    resultGuidanceChallengeAdvance:'次のノードはもう開いている。まず今回の報酬を受け取り、その勢いのまま先へ進む。',
    resultGuidanceRoadClear:'ロードは突破済み。まず報酬を受け取り、その後でより安定したクリアを狙って再走するか決める。',
    resultGuidanceQuickWin:'このデュエルは勝ち。まず報酬を受け取り、そのまま次の短期戦に入るか、先に構成を変えるか決める。',
    resultGuidanceQuickLoss:'基本報酬は受け取れている。先に構成を調整するか、そのままもう一戦短期戦へ入るかを決めればよい。',
    ...
    workshopCurrent:'現在',
    workshopNext:'次',
    workshopImpactLabel:'次の一戦への影響',
    workshopCostReady:'今すぐ強化しても {remaining} {currency} を残せる。',
    workshopCostShort:'この強化にはあと {shortfall} {currency} 必要。',
    workshopCostMaxed:'この研究ラインは最大。別のラインへ SCRAP を回せる。',
    ...
    challengeRewardKicker:'この勝利で得るもの',
    ...
    challengeGoalAdvance:'このノードを抜けば報酬を受け取り、次の対戦へ進める。',
    challengeGoalRetry:'今のノードが関門。初動と当て方を整えてから取り返しに戻る。',
  ...
  root.config.contentLocales = {
    zh:{
      ...
      enemyPresets:{
        ...
        trick_intro:{ label:'诡步试探' },
        impact_standard:{ label:'冲击重拳' },
        armor_ram:{ label:'装甲冲槌' },
        armor_unlock_intro:{ label:'装甲引导' },
        armor_hex_intro:{ label:'六角装甲引导' },
      ...
      challengeRoad:{
        ...
        'node-2':{ name:'心形切入', chapterLabel:'预选阶段', previewLabel:'心形入门', previewDesc:'先用更稳的装甲对手教你看懂心形碗场的安全走线，再把更刁钻的诡步压力放到后面。' },
        'node-3':{ name:'红线关口', chapterLabel:'预选阶段', previewLabel:'章节首领', previewDesc:'第一场检查点对决。爆发节奏更快，正面碰撞压力更强。' },
        'node-4':{ name:'六角闸门', chapterLabel:'场地巡回', previewLabel:'六角解锁', previewDesc:'一场受保护的六角引导战，会先让你熟悉新墙面和回弹节奏，之后的节点才会追求速度与爆发路线。' },
    ...
    ja:{
      ...
      enemyPresets:{
        ...
        trick_intro:{ label:'トリックスカウト' },
        impact_standard:{ label:'インパクトブルーザー' },
        armor_ram:{ label:'アーマーラム' },
        armor_unlock_intro:{ label:'アーマーガイド' },
        armor_hex_intro:{ label:'ヘックスアーマーガイド' },
      ...
      challengeRoad:{
        ...
        'node-2':{ name:'ハートカット', chapterLabel:'予選', previewLabel:'ハート入門', previewDesc:'まずは安定したアーマー相手に、ハートボウルの安全ラインを覚えさせる。癖の強いトリック圧は後ろへ回す。' },
        'node-3':{ name:'レッドラインゲート', chapterLabel:'予選', previewLabel:'チャプターボス', previewDesc:'最初のチェックポイント戦。高いバースト速度と正面衝突が主役。' },
        'node-4':{ name:'ヘックスゲート', chapterLabel:'アリーナサーキット', previewLabel:'ヘックス解放', previewDesc:'保護されたヘックス導入戦で、新しい壁と跳ね返りのリズムを先に覚える。速度やバーストの要求は後続ノードへ回す。' },

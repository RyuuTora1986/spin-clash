...
async function testDoubleRewardFailureFeedbackUsesMajorMessageBeat() {
  ...
  assert(failureMessage.text === 'DOUBLE REWARD DID NOT ACTIVATE. TAP AGAIN IF YOU WANT TO TRY ONCE MORE.', 'Expected failed double reward flow to preserve placement-specific reward guidance copy.');
